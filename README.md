...
| OpenAI Go #932 · `ff30d417` | `OPEN` · unmerged · mergeable · upstream CI authorization gate | Branch synchronized with current upstream `main`. Independent fork validation passed lint, Go 1.25.x, Go 1.26.x, supported-version aggregate, govulncheck, CodeQL (Go + Actions) and Castiron. The first independent CI run exposed an invalid JSON escape in the new regression fixture; it was corrected before the passing run. Upstream OpenAI Actions remain `action_required`, so no upstream CI pass or acceptance is claimed. | [PR #932](https://github.com/openai/openai-go/pull/932) · [Issue #631](https://github.com/openai/openai-go/issues/631) · [CI evidence](https://github.com/cstolting-collab/openai-go/actions/runs/35742159869) · [CodeQL](https://github.com/cstolting-collab/openai-go/actions/runs/35742159975) · [Castiron](https://github.com/cstolting-collab/openai-go/actions/runs/35742159450) |
